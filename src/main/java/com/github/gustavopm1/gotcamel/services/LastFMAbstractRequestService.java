...
public abstract class LastFMAbstractRequestService extends AbstractRequestService {

    /*
     * BASEURL terá que ser "http://ws.audioscrobbler.com/2.0/"
     * https://www.last.fm/api/intro
     *
     * */

    //TODO Create a ErroHandler class to handle the errors
    ...
    protected void setAPIKey(Map<String, String> headers) {
        headers.put(API_KEY, configuration.getApiKeyLFM());
    }

    @Override
    protected String getBaseUrl() {
        return configuration.getBaseUrlLFM();
    }
